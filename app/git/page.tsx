...
export default function Alias() {
    ...
    return (
        <div className="flex flex-col justify-center items-start">
            ...
            <FancyDate published="2025-01-19" updated="2025-01-19" />
            <article className="prose dark:prose-invert prose-headings:font-header prose-headings:text-base prose-headings:font-medium mt-14">
