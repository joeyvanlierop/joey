...
<Journal.Root>
  ...
  <Journal.Day date={"2024-01-09"}>
    <Journal.Entry time={"4:56pm"}>
      Too busy right now to write something, take this instead:
      <Video>
        <source src="/revelstoke.webm" type="video/webm" />
      </Video>
    </Journal.Entry>
  </Journal.Day>
</Journal.Root>
