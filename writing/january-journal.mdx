...
<Journal.Root>
    ...
    <Journal.Day date={"2024-01-06"}>
        <Journal.Entry time={"4:58pm"}>
            Today was about as painful as I expected, but that is the price we pay for pow. So many incredible lines, but the best had to be Greely Bowl. Chase and I followed some locals into one of the sketchiest lines on the mountain and had to play avoid the cliff the whole way down. 10/10.
        </Journal.Entry>
    </Journal.Day>
</Journal.Root>